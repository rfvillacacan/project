...
?>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      function loadProjectsDropdown(selected = '') {
        fetch('project_management/api/project_management_api.php?endpoint=projects')
          .then(resp => resp.json())
          .then(data => {
            const select = document.getElementById('edit-dailytask-project');
            if (!select) return;
          ...
          columns: [
            ...
            { data: null, orderable: false, render: function(data, type, row) {
                ...
                return `
                  ...
                  <button class="btn btn-sm btn-info select-project-btn" data-id="${row.id}">Select</button>
                `;
              }
            }
          ]
        ...
        var projectTasksTable = $('#projectTasksTable').DataTable({
          ajax: {
            ...
            data: function(d) {
              ...
              console.log('[DEBUG] ProjectTasksTable AJAX data:', d);
            },
            dataSrc: 'tasks'
          },
          paging: true,
  ...
  $(document).on('click', '.select-project-btn', function() {
